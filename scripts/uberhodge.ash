...
string mpRecoveryMemory = get_property("mpAutoRecoveryTarget");
string mpRecoveryItemMemory = get_property("mpAutoRecoveryItems");
...
void hodge(){
    ...
    set_property("mpAutoRecoveryItems","doc galaktik's invigorating tonic;magical mystery juice");
...
void main(){
    try{
        ...
        set_auto_attack(0);
        set_property("mpAutoRecoveryTarget",mpRecoveryMemory);
        set_property("mpAutoRecoveryItems",mpRecoveryItemMemory);
    }
}
